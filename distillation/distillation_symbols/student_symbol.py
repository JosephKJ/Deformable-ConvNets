...
class student_symbol(Symbol):
    ...
    def create_symbol(self, data):
        ...
        # Conv-BN-Relu 1
        conv1 = mx.symbol.Convolution(name='conv1', data=data, kernel=(5,5), num_filter=64,
                                      pad=(2, 2), stride=(2, 2))
        ...
        # Pool 1
        pool1 = mx.symbol.Pooling(name='pool1', data=relu1, pooling_convention='valid',
                                  pad=(0, 0), kernel=(2, 2), stride=(2, 2), pool_type='max')
    ...
    def create_symbol_left_of_resnet(self, data):
        """
        Create a symbol that is of the same output dimension as 4b22-layer of ResNet-101
        :param data: Data Symbol
        :return: mx.symbol
